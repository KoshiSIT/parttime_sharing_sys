!function (e, t) { "function" == typeof define && define.amd ? define(["exports"], t) : t("undefined" != typeof exports ? exports : e.syncscroll = {}) }
    (this, function (e) {
        var t = "Width",
            n = "Height",
            o = "Top",
            ...
            c = function () {
                ...
                for (e = 0; e < f.length; e++)
                    if (u = 0, l = f[e], d = l.getAttribute("name")) {
                        for (l = l.scroller || l, s[d] || (s[d] = []),
                            c = 0;
                            c < s[d].length; c++)s[d][c] == l && (u = 1);
...
var Timetable = function () {
    this.scope = { hourStart: 9, hourEnd: 17 },
        this.usingTwelveHour = !1, this.locations = [],
        this.events = []
};
Timetable.Renderer = function (e) {
    ...
    function () {
        ...
        function c(e, t) {
            var n; if (t) {
                var o = e >= 12 ? "PM" : "AM"; n = (e + 11) % 12 + 1 + ":00" + o
            } else {
                var r = e < 10 ? "0" : "";
                n = r + e + ":00"
            } return n
            ...
            setScope: function (t, n) {
                ...
                return this.scope.hourStart = t,
                    this.scope.hourEnd = n, this
            },
            useTwelveHour: function () { this.usingTwelveHour = !0 },
                ...
                draw: function (e) {
                    ...
                    function r(e) {
                        var t = e.appendChild(document.createElement("section")),
                            n = i(t), o = t.appendChild(document.createElement("time"));
                        ...
                        for (var n = t.appendChild(document.createElement("ul")),
                            o = !1,
                            r = !1,
                            i = m.scope.hourStart; !o;) {
                    ...
                    function u(e, t) {
                        for (var n = 0; n < m.events.length; n++) {
                            var o = m.events[n]; o.location === e && d(o, t)
                        }
                    }
                    function d(e, t) {
                        var n, o, r, i = void 0 !== e.options,
                            a = !1; i && (n = void 0 !== e.options.url, o = void 0 !== e.options["class"],
                                r = void 0 !== e.options.data, a = void 0 !== e.options.onClick);
                        var s = n ? "a" : "span",
                    ...
                    function f(e) {
                        var t = e.startDate, n = e.endDate, o = h(t, n); return o / v * 100 + "%"
                    }
                    function h(e, t) {
